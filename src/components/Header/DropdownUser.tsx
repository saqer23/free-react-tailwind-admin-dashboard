  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      <Link
        ...
        to="#"
      >
        <span className="hidden text-left lg:block rtl:text-right">
        ...
        <svg
          className="hidden fill-current sm:block rtl:rotate-180"
          width="12"
          height="8"
          viewBox="0 0 12 8"
          fill="none"
      ...
      {/* <!-- Dropdown Start --> */}
      {dropdownOpen && (
        <div className="absolute left-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark rtl:right-0 rtl:left-auto">
          <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark rtl:items-end">
            <li>
              <Link
                to="/profile"
                className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base rtl:flex-row-reverse"
              >
                <svg
